...
public class MapManager : MonoBehaviour
{
    ...
    //public void WarpPlayerInVillage(string targetPortalId)
    //{
    //    if (_villagePortalGroup.TryGetValue(targetPortalId, out var targetPortal))
    //    {
    //        if (_playerController != null)
    //        {
    //            _playerController.transform.position = targetPortal.transform.position;
    //            _playerController.WarpPosition(targetPortal.transform.position);
    //        }
    //    }
    //}
}